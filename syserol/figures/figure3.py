...
def makeFigure():
    ...
    ax[1].errorbar(comps, CMTFR2X, yerr = CMTFErr, fmt='none')
    ax[1].errorbar(comps, PCAR2X, yerr = PCAErr, fmt='none')
    ...
    ax[2].errorbar(missing, CMTFR2X, yerr=CMTFErr, fmt='none')
    ax[2].errorbar(missing, PCAR2X, yerr=PCAErr, fmt='none')
